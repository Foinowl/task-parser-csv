...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        CalculateService calculateService = new LogicService();

        List<Titanic> lists = calculateService.getListTitanic();
        ...
        System.out.println("3. Получить HashMap, где ключ - количество символов в имени, а значение - количество таких имен:");
